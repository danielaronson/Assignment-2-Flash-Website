...
<body class="container">
	...
	<p>
	When deciding on my major I was torn between Engineering and Computer Science. I was intrigued by engineering due to my deep interest in physics in high school. However, I knew computer science was a fascinating major as it required a substantial amount of logic and creativity. It took me 2 semesters to finalize on mechanical engineering, but I made sure to pursue a minor in computer science due to the fun I had in previous coding course I had taken. At the University of Rochester, I have taken: Intro to Programming, Data Structures, Web Design and Development and Statistical Programming. This semester I am taking Advanced Web Design and Robot Construction.
	</p>

	<h2> Mechanical Engineering Major</h2>
	<p>
	In regards to engineering coursework, I have loved the hands on experience I have gotten from my mechanical design class. I also enjoyed fluid dynamics and thermodynamics. For engineering internships, I spent the summer of 2017 in Rochester working for Nalco Water. This was a client facing role that involved working with various heating plants in the upstate New York area. I worked the summer of 2018 in Vermont for Keurig Dr Pepper as a Quality Engineering Intern. I worked on an engineering project, and was also able to work on a side project that involved SQL and Databases. I was able to work on the side project after expressing my interest in coding and big data. I thoroughly enjoyed my internship this summer. I also loved living in Burlington, Vermont. I had 4 other roommates that are all seniors at the University of Vermont. Over the summer, I frequently visited lake champlain and ate at all the great restaurants Burlington has to offer. Best of all, I received a lot of free coffee from Keurig.
	</p>

	
	<h2> Plans After College</h2>
	<p>
